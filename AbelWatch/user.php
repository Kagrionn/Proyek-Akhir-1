...
<html>
  ...
  <body>
    <center><h1><span><img src="image/logo1.png" style='position:absolute; left:540px; top:10px;' width="50"></span>AbelWatch</h1><center>
    <br/>
    <table>
      <thead>
        <tr>
    ...
    <tbody>
      ...
      ?>
       <tr>
          ...
          <td> 
              <a href="cart.php?id_produk=<?php echo $row['id_produk']; ?>">Beli</a>
          </td>
      </tr>
